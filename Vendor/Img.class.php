...
// fun��es para redimensionamento
	...
	*/	
	 ...
	 * @return void
	*/	
	private function resizeCrop1() 
	{
		// cria imagem de destino tempor�ria
		$imgtemp	= imagecreatetruecolor( $this->nova_largura, $this->nova_altura );
	
		imagecopyresampled( $imgtemp, $this->img, 0, 0, 0, 0, $this->largura, $this->altura, $this->largura, $this->altura );
	...
	public function resizeJcrop( $x, $y, $w, $h, $width = 940, $height = 360, $jpeg_quality = 90 )
	{
		
		$dst_r = ImageCreateTrueColor( $w, $h );

		imagecopyresampled( $dst_r, $this->img , 0, 0, $x, $y, $w , $h, $w, $h);
